...
from babi_util import parse_babi_task, build_model
...
class MemN2N(object):
    ...
    def __init__(self, data_dir, model_file):
        ...
        self.model_file     = model_file # './data_babi/memn2n_model.pklz'  # tasks_1-20_v1-2/en' # model_file
...
if __name__ == "__main__":
    ...
    parser.add_argument("-d", "--data-dir", default="data_babi/tasks_1-20_v1-2/en",
                        help="path to dataset directory (default: %(default)s)")
    parser.add_argument("-m", "--model-file", default="data_babi/memn2n_model.pklz",
